...
def main() -> int:
    tasks_path = ROOT / "prompts" / "keyframe-fix-tasks-v0.3.jsonl"
    output_dir = WORKSPACE / "HomeRun" / "06_exports" / "job-003-anime-episode-001-production" / "keyframes"
    manifest_path = ROOT / "progress" / "image-gen-web-keyframes-v0.3-fixes.jsonl"
    output_dir.mkdir(parents=True, exist_ok=True)
    (output_dir / "v0.3").mkdir(parents=True, exist_ok=True)
